...
public enum TargetStatusEnum {
    ...
    TargetStatusEnum(String name, Integer value) {
        this.value = value;
        this.name = name;
    }
     ...
     * @return
     */
    public static TargetStatusEnum getEnumByValue(String value) {
        if (ObjectUtils.isEmpty(value)) {
            return null;
        }
        for (TargetStatusEnum anEnum : TargetStatusEnum.values()) {
     ...
     * @return
     */
    public static TargetStatusEnum getEnumByName(Integer value) {
        if (ObjectUtils.isEmpty(value)) {
            return null;
        }
        for (TargetStatusEnum anEnum : TargetStatusEnum.values()) {
